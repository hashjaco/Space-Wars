...
public class GameEngine {
    ...
    public void fireIfReady(Player player, List<Bullet> player1bullets) {
        if (player.isFireReady()) {
            ...
            playMedia(new MediaPlayer(new Media(new File("/Users/hashimjacobs/OneDrive/Documents/CSC/CSC 413/csc413-secondgame-Team02-ScriptKiddie19/Invaders/src/sample/Sounds/lazer.wav").toURI().toString())));
        }
    }
        ...
        switch (player) {
            ...
            case 2:
                ...
                switch (secondPlayer.getScoreDigs()) {
                    case 1:
                        gc.fillText(("" + secondPlayer.getScore() + ""), viewportMinX + 40, secondPlayer.getHbY() + 38, 30);
                        break;
                    case 2:
        ...
        for (Player player : players) {
            ...
            for (GameObject asteroid : returnObjects1) {
                if (player.intersects(asteroid)) {
                    ...
                    if (player.getHealth() <= 0)
                        resetPlayer(player);
                    playMedia(new MediaPlayer(new Media(new File("/Users/hashimjacobs/OneDrive/Documents/CSC/CSC 413/csc413-secondgame-Team02-ScriptKiddie19/Invaders/src/sample/Sounds/explosion_x.wav").toURI().toString())));
                    deadAsteroids.add(asteroid);
                    asteroid.setDead();
            ...
            for (GameObject enemy : enemies){
                if (player.intersects(enemy)) {
                    ...
                    if (player.getHealth() <= 0)
                        resetPlayer(player);
                    playMedia(new MediaPlayer(new Media(new File("/Users/hashimjacobs/OneDrive/Documents/CSC/CSC 413/csc413-secondgame-Team02-ScriptKiddie19/Invaders/src/sample/Sounds/shottyToDaBody.wav").toURI().toString())));
