...
drifts. The art and audio are either hand-made by the author or generated by
`tools/GenerateAssets.java`, which is committed and deterministic — run
`tools/generate-assets.sh` to reproduce them.
